...
import { updateProduct, getTipoProdutos, type State } from '../actions';
...
type Product = {
    ...
    Tipo_produto_idTipo_produto: number;
};

export default function EditProductForm({ product }: { product: Product }) {
  const initialState: State = { message: null, errors: {} };
  const [state, dispatch, pending] = useActionState<State, FormData>(updateProduct, initialState);
      ...
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <select
            ...
            defaultValue={product.Tipo_produto_idTipo_produto}
            className="block w-full rounded-md border border-gray-200 py-2 px-3 text-sm"
        ...
        <div className="flex gap-4 mb-4">
            ...
            <div className="flex-1">
                ...
                <input
                    ...
                    name="cod_barras"
                    type="number"
                    defaultValue={product.cod_barras || ''}
                    className="block w-full rounded-md border border-gray-200 py-2 px-3 text-sm"
